...
result. Typically used after a LookupVector operation to filter entries
based on numeric values. See the Julia
[documentation](https://tanaylab.github.io/DataAxesFormats.jl/v0.2.0/queries.html#DataAxesFormats.Queries.IsLess)
for details.
