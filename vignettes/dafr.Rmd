...
dafr requires a working Julia installation (>= 1.10). Install Julia from
...
dafr provides a composable query system for extracting and transforming data.
...
dafr includes example datasets for testing and exploration:
...
- [dafr package documentation](https://tanaylab.github.io/dafr/) for the
